...
void runTestLesson1Task3() {
  ...
  testWidgets('module3', (WidgetTester tester) async {
    ...
    print('---------- Проверяем правильно ли выглядит активный виджет с текстом "$firstText" ----------');
    ...
    print('---------- Проверяем правильно ли выглядит активный виджет с текстом "$secondText" ----------');

    _checkActiveWidgetWithText(tester, secondText);

    print('---------- Проверяем правильно ли выглядит неактивный виджет с текстом "$firstText" ----------');
...
void _checkActiveWidgetWithText(final WidgetTester tester, final String enteredText) {
  final draggableMemeTextWithEnteredTextFinder = find.widgetWithText(MemeTextWidget, enteredText);
