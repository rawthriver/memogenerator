...
void runTestLesson1Task4() {
  ...
  testWidgets('module4', (WidgetTester tester) async {
    ...
    expect(
      fabFinder,
      findsOneWidget,
      reason: "ОШИБКА! На странице MainPage невозможно найти единственный виджет с типом FloatingActionButton",
    );
    ...
    final disabledInputBorder = tester.widget<TextField>(textFieldFinder).decoration!.disabledBorder ??
        tester.widget<TextField>(textFieldFinder).decoration!.border;
    final disabledInputBorderName =
        tester.widget<TextField>(textFieldFinder).decoration!.disabledBorder != null ? "disabledBorder" : "border";

    // если disabledBorder не равен null, то он будет иметь приоритет над border,
    // поэтому проверяем его в первую очерель
    print("В состоянии enabled=false у TextField $disabledInputBorderName должен быть типа UnderlineInputBorder");
    expect(
      disabledInputBorder,
      isInstanceOf<UnderlineInputBorder>(),
      reason: "ОШИБКА! В состоянии enabled=false у TextField $disabledInputBorderName неверного типа",
    );
    ...
    expect(
      ...
      reason: "ОШИБКА! В состоянии enabled=false у TextField в $disabledInputBorderName некорректный borderSide",
    );
    ...
    expect(
      ...
      findsOneWidget,
      reason: "ОШИБКА! На странице CreateMemePage невозможно найти единственную кнопку с текстом 'ДОБАВИТЬ ТЕКСТ'",
    );
    ...
    print('---------- Проверяем состояние, когда текст еще не введен, но есть текущий выделенный текст ----------');
    ...
    final enabledUnfocusedTextInputDecoration = tester.widget<TextField>(textFieldFinder).decoration;
    print("У найденного TextField decoration != null");
    expect(
    ...
    print("В состоянии enabled=true и без фокуса у TextField должен быть определен border или enabledBorder");
    expect(
      tester.widget<TextField>(textFieldFinder).decoration!.border != null ||
          tester.widget<TextField>(textFieldFinder).decoration!.enabledBorder != null,
      isTrue,
      reason: "ОШИБКА! В состоянии enabled=true и без фокуса у TextField border и enabledBorder равны null",
    );

    // если enabledBorder не равен null, то он будет иметь приоритет над border,
    // поэтому проверяем его в первую очерель
    final enabledUnfocusedBorder = tester.widget<TextField>(textFieldFinder).decoration!.enabledBorder ??
        tester.widget<TextField>(textFieldFinder).decoration!.border;
    final enabledUnfocusedBorderName =
        tester.widget<TextField>(textFieldFinder).decoration!.enabledBorder != null ? "enabledBorder" : "border";
    print(
    ...
    expect(
      ...
      isInstanceOf<UnderlineInputBorder>(),
      reason: "ОШИБКА! В состоянии enabled=true и без фокуса у TextField $enabledUnfocusedBorderName неверного типа",
    );
    ...
    print("В состоянии enabled=true и с фокусом у TextField должен быть определен border или focusedBorder");
    expect(
      tester.widget<TextField>(textFieldFinder).decoration!.border != null ||
          tester.widget<TextField>(textFieldFinder).decoration!.focusedBorder != null,
      isTrue,
      reason: "ОШИБКА! В состоянии enabled=true и с фокусом у TextField border и focusedBorder равны null",
    );

    // если focusedBorder не равен null, то он будет иметь приоритет над border,
    // поэтому проверяем его в первую очерель
    final enabledFocusedBorder = tester.widget<TextField>(textFieldFinder).decoration!.focusedBorder ??
        tester.widget<TextField>(textFieldFinder).decoration!.border;
    final enabledFocusedBorderName =
        tester.widget<TextField>(textFieldFinder).decoration!.focusedBorder != null ? "focusedBorder" : "border";
    print(
    ...
    expect(
      ...
      isInstanceOf<UnderlineInputBorder>(),
      reason: "ОШИБКА! В состоянии enabled=true и с фокусом у TextField $enabledFocusedBorderName неверного типа",
    );
