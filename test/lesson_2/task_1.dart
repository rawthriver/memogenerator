...
void runTestLesson2Task1() {
  ...
  testWidgets('module1', (WidgetTester tester) async {
    ...
    final bottomMemeTextWithFirstTextFinder = find.widgetWithText(BottomMemeItem, firstText);
    ...
    final bottomMemeTextWithSecondTextFinder = find.widgetWithText(BottomMemeItem, secondText);
